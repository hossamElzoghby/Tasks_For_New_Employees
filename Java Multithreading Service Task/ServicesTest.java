 ...
 *
 */
public class ServicesTest extends ServiceLifecycle{

    @Override
    public List<String> getIds(ServiceData serviceData, List<String> controlList) {
        List<String> idsList;
        DataAccess da = new DataAccess(this);
        idsList= da.selectRecords("","ACCOUNT","", "WITH CATEGORY EQ 1001 AND CURRENCY EQ USD");
        return idsList;
    }
