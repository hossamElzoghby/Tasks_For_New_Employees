...
* <Rating>-7</Rating>
*-----------------------------------------------------------------------------
SUBROUTINE TASK7.TASK7.FIELDS
*-----------------------------------------------------------------------------
*<doc>
* Template for field definitions routine TASK7.TASK7.FIELDS
*
...
*-----------------------------------------------------------------------------
    ...
    EB.Template.TableAddreservedfield('RESERVED8')
    EB.Template.TableAddreservedfield('RESERVED9')
    EB.Template.TableAddreservedfield('RESERVED10')
    Neighbour=''
